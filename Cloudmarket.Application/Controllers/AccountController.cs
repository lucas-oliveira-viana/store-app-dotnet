...
using Cloudmarket.Web;

namespace Cloudmarket.Application.Controllers
{
    [Authorize]
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Email, Nome = model.Nome, Email = model.Email, DataNascimento = model.DataNascimento, CPF = model.CPF, Rg = model.Rg };
